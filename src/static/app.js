...
Application.prototype.start = function () {
  ...
  this.tuner.onNoteDetected = function (note) {
    console.log("testing", self.notes.isAutoMode)
  ...
  swal.fire("Welcome to the floating-bridge guitar tuner!").then(function () {
    self.tuner.init();
    self.frequencyData = new Uint8Array(self.tuner.analyser.frequencyBinCount);
    
    // Initialize the tuning interface
    self.tuningInterface = new TuningInterface(self.tuner, self.notes, self.meter);
  });
